...
{
    // NOTE. We could write the following code using iterators instead
    //  of indices. Then this function could work with bidirectional
    //  iterators.
...
void quicksort_recurse(RAIter first, RAIter last)
{
    while (true)  // For tail-recursion elimination
    {
        ...
        const size_t SMALL_SIZE = 32;  // Max size of "small" sublist
